/*
  # Add Premium Challenge Support
  
  1. New Tables
    - `premium_challenges`
      - Stores premium challenge configuration and status
      - Tracks entry fees, prize pools, and player counts
    - `premium_challenge_registrations` 
      - Tracks player registrations and payment status
      - Links to Stripe payments

  2. Changes
    - Added support for premium challenges with entry fees
    - Added prize pool calculation and distribution
    - Added player registration tracking

  3. Security
    - RLS policies for premium challenge access
