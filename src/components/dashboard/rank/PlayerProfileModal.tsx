...
export function PlayerProfileModal({ player, onClose, applyPosition, position }: PlayerProfileModalProps) {
  ...
  return (
    <div 
      ...
      style={applyPosition ? position : {}}
    >
      {/* Solid background overlay with blur */}
      <div className="absolute inset-0 bg-black/90 backdrop-blur-md" onClick={onClose} />
      
      <div 
        className="w-full max-w-md bg-gray-800 rounded-lg shadow-2xl border border-gray-700/50 z-10"
